...
const tom = new Person('Tom', 50);
console.log('Task 1', tom.toString());
tom.eat('banh beo');
...
const david = new Baby('David', 3, 'Drawing Book');
david.play();
...
/* 
  ...
  4. new binding = When a function is created as a constructor this pints to the newly create object
*/
